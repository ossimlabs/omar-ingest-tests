...
featureTemplateFiles = [
    templates:[
        avro_staging:[
            template_file:"src/cucumber/resources/features/templates/staging.template",
            feature_file:"src/cucumber/resources/features/01_Staging_Service.feature",
            data:"staging_data"
        ],
        direct_s3_staging:[
            template_file:"src/cucumber/resources/features/templates/s3_staging.template",
            feature_file:"src/cucumber/resources/features/02_Direct_S3_Staging_Service.feature",
            data:"s3_staging_data"
        ],
        local_staging:[
            template_file:"src/cucumber/resources/features/templates/local_staging.template",
            feature_file:"src/cucumber/resources/features/04_Local_Staging_Service.feature",
            data:"local_staging_data"
        ],
        multi_staging:[
            template_file:"src/cucumber/resources/features/templates/multi_staging.template",
            feature_file:"src/cucumber/resources/features/03_Staging_Multi_Ingest_Service.feature",
            data:"staging_data"
        ]
    ]
]
    ...
    staging_data:[
        images:[
            image_01:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/Cosmo+SkyMED/NITF/04APR16CS0207001_110646_SM0262R_29N081W_001X___SHH_0101_OBS_IMAG.nitf"
            ],
            image_02:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/QuickBird/TIFF/Muliti/04DEC11050020-M2AS_R1C1-000000185964_01_P001.TIF"
            ],
            image_03:[
                image_id:"04DEC11050020-P2AS_R1C1-000000185964_01_P001",
                file_name:"04DEC11050020-P2AS_R1C1-000000185964_01_P001.TIF",
                observation_time:"2011-12-04T05:00:20.000Z",
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/QuickBird/TIFF/Pan/04DEC11050020-P2AS_R1C1-000000185964_01_P001.TIF"
            ],
            image_04:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/Radarsat/NITF/04MAY16RS0208001_132348_SM0280R_31N111W_001C___SHH_0101_OBS_IMAG.nitf"
            ],
            image_05:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/GeoEye/NITF2_1/multi/05FEB09OV05010005V090205M0001912264B220000100072M_001508507.ntf"
            ],
            image_06:[
                ...
                observation_time:"2009-02-05T00:02:01.000Z",
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/GeoEye/NITF2_1/Pan/05FEB09OV05010005V090205P0001912264B220000100282M_001508507.ntf"
            ],
            image_07:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/WorldView/WV2/NITF/11MAR08WV010500008MAR11071429-P1BS-005707719010_04_P003.ntf"
            ],
            image_08:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/GeoEye/GeoTIFF/Multi/14AUG20010406-M1BS-053852449040_01_P001.TIF"
            ],
            image_09:[
                image_id:"14AUG20010406-P1BS-053852449040_01_P001",
                file_name:"14AUG20010406-P1BS-053852449040_01_P001.TIF",
                observation_time:"2001-08-14T04:06:00.000Z",
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/GeoEye/GeoTIFF/Pan/14AUG20010406-P1BS-053852449040_01_P001.TIF"
            ],
            image_10:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/WorldView/WV3/GeoTIFF/Multi/14OCT15165809-M1BS-053951940010_01_P001.TIF"
            ],
            image_11:[
                image_id:"14OCT15165809-P1BS-053951940010_01_P001",
                file_name:"14OCT15165809-P1BS-053951940010_01_P001.TIF",
                observation_time:"2015-10-14T16:58:09.000Z",
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/WorldView/WV3/GeoTIFF/Pan/14OCT15165809-P1BS-053951940010_01_P001.TIF"
            ],
            image_12:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/TerraSAR-X/NITF2_0/14SEP15TS0107001_100021_SL0023L_25N121E_001X___SVV_0101_OBS_IMAG.ntf"
            ],
            image_13:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/WorldView/WV2/GeoTIFF/Multi/14SEP12113301-M1BS-053951940020_01_P001.TIF"
            ],
            image_14:[
                image_id:"14SEP12113301-P1BS-053951940020_01_P001",
                file_name:"14SEP12113301-P1BS-053951940020_01_P001.TIF",
                observation_time:"2012-09-14T11:33:01.000Z",
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/WorldView/WV2/GeoTIFF/Pan/14SEP12113301-P1BS-053951940020_01_P001.TIF"
            ],
            image_15:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/Paris/16MAY02111606-P1BS-055998375010_01_P013.TIF"
            ],
            image_16:[
                image_id:"16MAY02111607-P1BS-055998375010_01_P014",
                file_name:"16MAY02111607-P1BS-055998375010_01_P014.TIF",
                observation_time:"2016-05-02T00:00:00.000Z",
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/Paris/16MAY02111607-P1BS-055998375010_01_P014.TIF"
            ],
            image_17:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/TerraSAR-X/NITF2_0/26JAN16TS0109001_130755_DS0110L_33N106W_001X___SVV_0101_OBS_IMAG.ntf"
            ],
            image_18:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/Radarsat/NITF/28APR16RS0207001_111844_SL0080R_28N082W_001C___SHH_0101_OBS_IMAG.nitf"
            ],
            image_19:[
                ...
                url:"https://s3.amazonaws.com/o2-test-data/Standard_test_imagery_set/RapidEye/TIFF/2010-12-05T221358_RE2_3A-NAC_6683383_113276.tif"
            ]
        ]
    ],
    local_staging_data:[
